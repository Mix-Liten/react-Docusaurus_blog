...
從字面意思上看，"始終保持離開" 聽上去是一個可怕的建議。為什麼一個好的領導者要嘗試離開他的團隊呢？事實上這是參考的Google前工程主管 Bharat Mediratta 的話。他的意思是你的任務不僅僅是解決邊界模糊的問題，而是還要引導你的團隊在沒有你在場的情況下自己解決問題。如果你能做到這點，將釋放你一部分精力去解決新的問題（或去管理新的團隊），在你身後留下一個個能自給自足的團隊。
